...
export function buildRunbookOnlyScope(): string {
  ...
  return [
    ...
    'For runbook changes, use the matching proposal tool. Proposals are pending drafts, never executions, regardless of their actions. Claim creation, edits, or saving only after operator approval and successful persistence.',
